'package net.fimastgd.forevercore.SystemControl.connection.checkBanned';
"use strict";
...
async function checkActive(id, node) {
    try {
        ...
        // Установка isBanned на true если GDPS забанен, на false если нет
        let isBanned = Boolean(props.isBanned);
        // возвращаем Promise<boolean>
        return isBanned;
    }
    catch (e) {
        console_api_1.default.Error("SystemControl", `${e} at net.fimastgd.forevercore.SystemControl.SystemControl.connection.checkBanned`);
        return false;
    }
}
