...
class GJPCheck {
     ...
     */
    static async validateGJPOrDie(gjp: string, accountID: string | number, req: Request): Promise<void> {
     ...
     * @returns Promise that resolves if valid, or rejects with "-1"
     */
    static async validateGJP2OrDie(gjp2: string, accountID: string | number, req: Request): Promise<void> {
     ...
     * @param req - Express request
     */
    static async logInvalidAttemptFromIP(accid: string | number, req: Request): Promise<void> {
        const ip = await FixIp.getIP(req);
     ...
     * @returns 1 if valid, 0 if invalid, -1 if too many attempts, -2 if account inactive
     */
    static async isGJP2Valid(accid: string | number, gjp2: string, req: Request): Promise<number> {
     ...
     */
    static async assignGJP2(accid: string | number, pass: string, req?: Request): Promise<any> {
     ...
     * @returns 1 if valid, 0 if invalid, -1 if too many attempts, -2 if account inactive
     */
    static async isValid(accid: string | number, pass: string, req: Request): Promise<number> {
