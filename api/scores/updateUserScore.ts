...
const updateUserScore = async (
	...
	try {
		...
		// Get user ID
		const id = await ApiLib.getIDFromPost(gdpsid, udidStr, gameVersionStr, accountIDStr, gjp2Str, gjpStr, req);
      ...
      `;
			...
			dinfo =
				`${easyNormal + demonsCountDiff},${mediumNormal},${hardNormal},${insaneNormal},${extremeNormal},` +
