          ...
          SELECT rank, stars FROM (
			...
			for (const user of result) {
				...
				if (date === "1-4") {
					...
					// Normal display
					lbstring += `1:${user.userName}:2:${user.userID}:13:${user.coins}:17:${user.userCoins}:6:${xi}:9:${user.icon}:10:${
						user.color1
					}:11:${user.color2}:51:${user.color3}:14:${user.iconType}:15:${user.special}:16:${extid}:3:${user.stars}:8:${Math.round(
						user.creatorPoints
					)}:4:${user.demons}:7:${extid}:46:${user.diamonds}:52:${user.moons}|`;
				}
			}
			...
			for (const user of result2) {
				...
				if (date === "1-4") {
					// April Fools day
					const rndS: number = Random.Int(1, 3);
					switch (rndS) {
						case 1:
							lbstring += `1:FimastGD blew up gdps:2:${user.userID}:13:999:17:999:6:${xi}:9:9:10:9:11:8:14:1:15:3:16:${extid}:3:999:8:99999:4:999:7:${extid}:46:99999|`;
							break;
						case 2:
							...
							break;
						case 3:
							lbstring += `1:GDPS exploded by Connor:2:${user.userID}:13:999:17:999:6:${xi}:9:9:10:9:11:8:14:1:15:3:16:${extid}:3:999:8:99999:4:999:7:${extid}:46:99999|`;
							break;
						default:
							lbstring += `1:RobNotFriend:2:${user.userID}:13:999:17:999:6:${xi}:9:9:10:9:11:8:14:1:15:3:16:${extid}:3:999:8:99999:4:999:7:${extid}:46:99999|`;
							break;
					...
					lbstring += `1:${user.userName}:2:${user.userID}:13:${user.coins}:17:${user.userCoins}:6:${xi}:9:${user.icon}:10:${
						user.color1
					}:11:${user.color2}:14:${user.iconType}:15:${user.special}:16:${extid}:3:${user.stars}:8:${Math.floor(user.creatorPoints)}:4:${
						user.demons
					}:7:${extid}:46:${user.diamonds}|`;
				}
			}
		}
